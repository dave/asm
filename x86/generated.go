...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=131
...
// al: AL/AX/EAX/RAX
// imm: imm8
// https://golang.org/s/x86manual#page=133
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=135
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=138
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=141
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=143
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=145
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=147
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=150
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=152
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=154
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=156
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=158
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=160
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=161
...
// al: AL/AX/EAX/RAX
// imm: imm8
// https://golang.org/s/x86manual#page=163
...
// vex: VEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=165
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=172
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=175
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=166
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=169
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=178
...
// rm: ModRM:r/m (r)
// vex: VEX.vvvv (r)
// https://golang.org/s/x86manual#page=182
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=180
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=183
...
// https://golang.org/s/x86manual#page=185
...
// rm: ModRM:r/m (r)
// implicit: implicit XMM0
// https://golang.org/s/x86manual#page=187
...
// vex: VEX.vvvv (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=190
...
// vex: VEX.vvvv (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=191
...
// vex: VEX.vvvv (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=192
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=193
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=195
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=197
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=200
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=202
...
// rm: ModRM:r/m (r)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=205
...
// reg: ModRM:reg (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=208
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=210
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=212
...
// https://golang.org/s/x86manual#page=214
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=215
...
// rm: ModRM:r/m (r, w)
// imm: imm8
// https://golang.org/s/x86manual#page=217
...
// rm: ModRM:r/m (r, w)
// imm: imm8
// https://golang.org/s/x86manual#page=219
...
// rm: ModRM:r/m (r, w)
// imm: imm8
// https://golang.org/s/x86manual#page=221
...
// rm: ModRM:r/m (r)
// vex: VEX.vvvv (r)
// https://golang.org/s/x86manual#page=223
...
// Call far, absolute, address given in operand.
// offset: Offset
// https://golang.org/s/x86manual#page=224
...
// https://golang.org/s/x86manual#page=237
func CBW() {
	unsafe.Asm("CBW", nil)
}
...
// https://golang.org/s/x86manual#page=380
func CDQ() {
	unsafe.Asm("CDQ", nil)
}
...
// https://golang.org/s/x86manual#page=238
func CLAC() {
	unsafe.Asm("CLAC", nil)
}
...
// CLC
// Clear CF flag.
// https://golang.org/s/x86manual#page=239
func CLC() {
	unsafe.Asm("CLC", nil)
}
...
// CLD
// Clear DF flag.
// https://golang.org/s/x86manual#page=240
func CLD() {
	unsafe.Asm("CLD", nil)
}
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=241
...
// Flushes cache line containing m8.
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=243
...
// https://golang.org/s/x86manual#page=245
func CLI() {
	unsafe.Asm("CLI", nil)
}
...
// https://golang.org/s/x86manual#page=247
func CLTS() {
	unsafe.Asm("CLTS", nil)
}
...
// CMC
// Complement CF flag.
// https://golang.org/s/x86manual#page=250
func CMC() {
	unsafe.Asm("CMC", nil)
}
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=251
...
// al: AL/AX/EAX/RAX (r)
// imm: imm8
// https://golang.org/s/x86manual#page=255
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=257
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=264
...
// https://golang.org/s/x86manual#page=271
func CMPSB() {
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=275
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=279
...
// rm: ModRM:r/m (r, w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=283
...
// rm: ModRM:r/m (r, w)
// https://golang.org/s/x86manual#page=285
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=288
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=290
...
// https://golang.org/s/x86manual#page=292
func CPUID() {
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=327
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=330
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=341
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=342
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=346
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=347
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=348
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=351
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=354
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=355
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=357
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=359
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=361
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=363
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=365
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=367
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=371
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=372
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=375
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=376
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=378
...
// https://golang.org/s/x86manual#page=381
func DAA() {
	unsafe.Asm("DAA", nil)
}
...
// https://golang.org/s/x86manual#page=383
func DAS() {
	unsafe.Asm("DAS", nil)
}
...
// Decrement r/m8 by 1.
// rm: ModRM:r/m (r, w)
// https://golang.org/s/x86manual#page=385
...
// Unsigned divide AX by r/m8, with result stored in AL ← Quotient, AH ← Remainder.
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=387
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=390
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=393
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=396
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=398
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=400
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=402
...
// https://golang.org/s/x86manual#page=405
func EMMS() {
	unsafe.Asm("EMMS", nil)
}
...
// iw: iw
// imm: imm8
// https://golang.org/s/x86manual#page=406
...
// https://golang.org/s/x86manual#page=411
func F2XM1() {
...
// https://golang.org/s/x86manual#page=413
func FABS() {
	unsafe.Asm("FABS", nil)
}
...
// st0: ST(0) (r, w)
// sti: ST(i) (r)
// https://golang.org/s/x86manual#page=414
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=417
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=419
...
// https://golang.org/s/x86manual#page=421
func FCHS() {
	unsafe.Asm("FCHS", nil)
}
...
// https://golang.org/s/x86manual#page=423
func FCLEX() {
...
// st0: ST(0) (r, w)
// sti: ST(i) (r)
// https://golang.org/s/x86manual#page=425
...
// https://golang.org/s/x86manual#page=427
func FCOM() {
	unsafe.Asm("FCOM", nil)
}
...
// st0: ST(0) (r)
// sti: ST(i) (r)
// https://golang.org/s/x86manual#page=430
...
// https://golang.org/s/x86manual#page=433
func FCOS() {
	unsafe.Asm("FCOS", nil)
}
...
// https://golang.org/s/x86manual#page=435
func FDECSTP() {
...
// st0: ST(0) (r, w)
// sti: ST(i) (r)
// https://golang.org/s/x86manual#page=436
...
// st0: ST(0) (r, w)
// sti: ST(i) (r)
// https://golang.org/s/x86manual#page=439
...
// sti: ST(i) (w)
// https://golang.org/s/x86manual#page=442
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=443
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=445
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=463
...
// https://golang.org/s/x86manual#page=447
func FINCSTP() {
...
// https://golang.org/s/x86manual#page=448
func FINIT() {
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=450
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=453
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=497
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=500
...
// sti: ST(i) (r)
// https://golang.org/s/x86manual#page=455
...
// https://golang.org/s/x86manual#page=457
func FLD1() {
	unsafe.Asm("FLD1", nil)
}
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=459
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=461
...
// https://golang.org/s/x86manual#page=466
func FNOP() {
	unsafe.Asm("FNOP", nil)
}
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=478
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=491
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=493
...
// ax: AX (w)
// https://golang.org/s/x86manual#page=495
...
// https://golang.org/s/x86manual#page=467
func FPATAN() {
...
// https://golang.org/s/x86manual#page=469
func FPREM() {
...
// https://golang.org/s/x86manual#page=471
func FPREM1() {
...
// https://golang.org/s/x86manual#page=473
func FPTAN() {
...
// https://golang.org/s/x86manual#page=475
func FRNDINT() {
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=476
...
// FSCALE
// Scale ST(0) by ST(1).
// https://golang.org/s/x86manual#page=481
func FSCALE() {
...
// https://golang.org/s/x86manual#page=483
func FSIN() {
	unsafe.Asm("FSIN", nil)
}
...
// https://golang.org/s/x86manual#page=485
func FSINCOS() {
...
// https://golang.org/s/x86manual#page=487
func FSQRT() {
...
// Copy ST(0) to m64fp.
// sti: ST(i) (w)
// https://golang.org/s/x86manual#page=489
...
// https://golang.org/s/x86manual#page=503
func FTST() {
	unsafe.Asm("FTST", nil)
}
...
// Compare ST(0) with ST(1).
// Compare ST(0) with ST(i).
// https://golang.org/s/x86manual#page=505
func FUCOM() {
...
// https://golang.org/s/x86manual#page=1923
func FWAIT() {
...
// https://golang.org/s/x86manual#page=508
func FXAM() {
	unsafe.Asm("FXAM", nil)
}
...
// https://golang.org/s/x86manual#page=510
func FXCH() {
	unsafe.Asm("FXCH", nil)
}
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=512
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=515
...
// https://golang.org/s/x86manual#page=523
func FXTRACT() {
...
// https://golang.org/s/x86manual#page=525
func FYL2X() {
...
// https://golang.org/s/x86manual#page=527
func FYL2XP1() {
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=529
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=532
...
// HLT
// Halt
// https://golang.org/s/x86manual#page=535
func HLT() {
	unsafe.Asm("HLT", nil)
}
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=536
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=539
...
// Signed divide AX by r/m8, with result stored in AL ← Quotient, AH ← Remainder.
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=542
...
// AX← AL ∗ r/m byte.
// rm: ModRM:r/m (r, w)
// https://golang.org/s/x86manual#page=545
...
// al: AL (w)
// imm: imm8 (r)
// https://golang.org/s/x86manual#page=549
...
// Increment r/m byte by 1.
// rm: ModRM:r/m (r, w)
// https://golang.org/s/x86manual#page=551
...
// https://golang.org/s/x86manual#page=553
func INSB() {
	unsafe.Asm("INSB", nil)
}
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=556
...
// imm: imm8
// https://golang.org/s/x86manual#page=559
...
// https://golang.org/s/x86manual#page=571
func INVD() {
	unsafe.Asm("INVD", nil)
}
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=573
...
// reg: ModRM:reg (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=575
...
// https://golang.org/s/x86manual#page=578
func IRET() {
	unsafe.Asm("IRET", nil)
}
...
// offset: Offset
// https://golang.org/s/x86manual#page=585
...
// Jump far, absolute, address given in operand
// offset: Offset
// https://golang.org/s/x86manual#page=590
...
// https://golang.org/s/x86manual#page=598
...
// reg: ModRM:reg (w)
// vex: VEX.1vvv (r) ModRM:r/m (r, ModRM:[7:6] must be 11b)
// https://golang.org/s/x86manual#page=599
...
// reg: ModRM:reg (w)
// vex: VEX.1vvv (r) ModRM:r/m (r, ModRM:[7:6] must be 11b)
// https://golang.org/s/x86manual#page=600
...
// https://golang.org/s/x86manual#page=601
func KMOVB_MR() {
...
// reg: ModRM:reg (w) ModRM:r/m (r, ModRM:[7:6] must be 11b)
// https://golang.org/s/x86manual#page=603
...
// reg: ModRM:reg (w)
// vex: VEX.1vvv (r) ModRM:r/m (r, ModRM:[7:6] must be 11b)
// https://golang.org/s/x86manual#page=604
...
// reg: ModRM:reg (w) ModRM:r/m (r, ModRM:[7:6] must be 11b)
// https://golang.org/s/x86manual#page=605
...
// arg:
// imm: imm8
// https://golang.org/s/x86manual#page=607
...
// arg:
// imm: imm8
// https://golang.org/s/x86manual#page=609
...
// reg: ModRM:reg (w)
// vex: VEX.1vvv (r) ModRM:r/m (r, ModRM:[7:6] must be 11b)
// https://golang.org/s/x86manual#page=613
...
// reg: ModRM:reg (w)
// vex: VEX.1vvv (r) ModRM:r/m (r, ModRM:[7:6] must be 11b)
// https://golang.org/s/x86manual#page=614
...
// reg: ModRM:reg (w)
// vex: VEX.1vvv (r) ModRM:r/m (r, ModRM:[7:6] must be 11b)
// https://golang.org/s/x86manual#page=615
...
// https://golang.org/s/x86manual#page=616
func LAHF() {
	unsafe.Asm("LAHF", nil)
}
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=617
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=620
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=622
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=623
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=627
...
// https://golang.org/s/x86manual#page=629
func LEAVE() {
...
// https://golang.org/s/x86manual#page=631
func LFENCE() {
...
// Load m into GDTR.
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=632
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=635
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=637
...
// https://golang.org/s/x86manual#page=639
func LOCK() {
	unsafe.Asm("LOCK", nil)
}
...
// https://golang.org/s/x86manual#page=641
func LODSB() {
...
// offset: Offset
// https://golang.org/s/x86manual#page=644
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=646
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=649
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=651
...
// reg: ModRM:reg (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=660
...
// reg: ModRM:reg (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=662
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=664
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=667
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=670
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=672
...
// https://golang.org/s/x86manual#page=674
func MFENCE() {
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=675
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=678
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=681
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=683
...
// https://golang.org/s/x86manual#page=685
func MONITOR() {
...
// al: AL/AX/EAX/RAX
// moffs: Moffs
// https://golang.org/s/x86manual#page=687
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=692
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=697
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=701
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=705
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=707
...
// vex: VEX.vvvv
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1753
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=727
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=714
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=728
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=734
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=740
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=742
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=746
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=744
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=748
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=750
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=752
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=754
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=755
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=758
...
// https://golang.org/s/x86manual#page=759
func MOVSB() {
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=766
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=776
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=786
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=788
...
// Unsigned multiply (AX ← AL ∗ r/m8).
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=796
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=798
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=801
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=804
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=806
...
// vex: VEX.vvvv (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=808
...
// https://golang.org/s/x86manual#page=810
func MWAIT() {
...
// Two's complement negate r/m8.
// rm: ModRM:r/m (r, w)
// https://golang.org/s/x86manual#page=813
...
// Multi-byte no-operation instruction.
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=815
...
// Reverse each bit of r/m8.
// rm: ModRM:r/m (r, w)
// https://golang.org/s/x86manual#page=816
...
// al: AL/AX/EAX/RAX
// imm: imm8/16/32
// https://golang.org/s/x86manual#page=818
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=820
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=823
...
// imm: imm8 (r)
// al: AL (r)
// https://golang.org/s/x86manual#page=826
...
// https://golang.org/s/x86manual#page=828
func OUTSB() {
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=832
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=838
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=846
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=851
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=863
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=867
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=871
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=875
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=878
...
// https://golang.org/s/x86manual#page=881
func PAUSE() {
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=882
...
// rm: ModRM:r/m (r)
// xmm: <XMM0>
// https://golang.org/s/x86manual#page=886
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=890
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=893
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=896
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=902
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=905
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=907
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=909
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=915
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=918
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=920
...
// vex: VEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=922
...
// vex: VEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=924
...
// reg: ModRM:reg (r)
// imm: imm8
// https://golang.org/s/x86manual#page=926
...
// reg: ModRM:reg (r)
// imm: imm8
// https://golang.org/s/x86manual#page=929
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=932
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=936
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=938
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=940
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=943
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=945
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=948
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=950
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=953
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=956
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=963
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=972
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=981
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=986
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=990
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=992
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1002
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1011
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1014
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1018
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1022
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1030
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1034
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1037
...
// https://golang.org/s/x86manual#page=1042
func POPA() {
	unsafe.Asm("POPA", nil)
}
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1044
...
// https://golang.org/s/x86manual#page=1046
func POPF() {
	unsafe.Asm("POPF", nil)
}
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1051
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1054
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1056
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1058
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1064
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1068
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1072
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1075
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1078
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1079
...
// rm: ModRM:r/m (r, w)
// imm: imm8
// https://golang.org/s/x86manual#page=1085
...
// rm: ModRM:r/m (r, w)
// imm: imm8
// https://golang.org/s/x86manual#page=1083
...
// rm: ModRM:r/m (r, w)
// imm: imm8
// https://golang.org/s/x86manual#page=1097
...
// rm: ModRM:r/m (r, w)
// imm: imm8
// https://golang.org/s/x86manual#page=1109
...
// rm: ModRM:r/m (r, w)
// imm: imm8
// https://golang.org/s/x86manual#page=1107
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1121
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1128
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1131
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1135
...
// reg: ModRM:reg (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1139
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1143
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1153
...
// Push imm8.
// imm: imm8/16/32
// https://golang.org/s/x86manual#page=1163
...
// https://golang.org/s/x86manual#page=1166
func PUSHA() {
...
// https://golang.org/s/x86manual#page=1168
func PUSHF() {
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1170
...
// rm: ModRM:r/m (w)
// v1: 1
// https://golang.org/s/x86manual#page=1173
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1178
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1180
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1182
...
// https://golang.org/s/x86manual#page=1184
func RDMSR() {
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1186
...
// RDPKRU
// Reads PKRU into EAX.
// https://golang.org/s/x86manual#page=1187
func RDPKRU() {
...
// https://golang.org/s/x86manual#page=1189
func RDPMC() {
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1193
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1195
...
// https://golang.org/s/x86manual#page=1197
func RDTSC() {
...
// https://golang.org/s/x86manual#page=1199
func RDTSCP() {
...
// imm: imm16
// https://golang.org/s/x86manual#page=1205
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1215
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1216
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1219
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1222
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1224
...
// https://golang.org/s/x86manual#page=1226
func RSM() {
	unsafe.Asm("RSM", nil)
}
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1228
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1230
...
// https://golang.org/s/x86manual#page=1232
func SAHF() {
	unsafe.Asm("SAHF", nil)
}
...
// rm: ModRM:r/m (r, w)
// v1: 1
// https://golang.org/s/x86manual#page=1234
...
// rm: ModRM:r/m (r)
// vex: VEX.vvvv (r)
// https://golang.org/s/x86manual#page=1239
...
// al: AL/AX/EAX/RAX
// imm: imm8/16/32
// https://golang.org/s/x86manual#page=1241
...
// https://golang.org/s/x86manual#page=1244
func SCASB() {
...
// Set byte if above (CF=0 and ZF=0).
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1248
...
// https://golang.org/s/x86manual#page=1251
func SFENCE() {
...
// Store GDTR to m.
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1252
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1257
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1258
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1256
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1254
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1261
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1262
...
// https://golang.org/s/x86manual#page=1259
func SHA256RNDS2() {
...
// reg: ModRM:reg (r)
// cl: CL
// https://golang.org/s/x86manual#page=1263
...
// reg: ModRM:reg (r)
// cl: CL
// https://golang.org/s/x86manual#page=1266
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1269
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1274
...
// Store IDTR to m.
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1278
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1280
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1282
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1284
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1287
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1290
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1292
...
// https://golang.org/s/x86manual#page=1294
func STAC() {
	unsafe.Asm("STAC", nil)
}
...
// STC
// Set CF flag.
// https://golang.org/s/x86manual#page=1295
func STC() {
	unsafe.Asm("STC", nil)
}
...
// STD
// Set DF flag.
// https://golang.org/s/x86manual#page=1296
func STD() {
	unsafe.Asm("STD", nil)
}
...
// https://golang.org/s/x86manual#page=1297
func STI() {
	unsafe.Asm("STI", nil)
}
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1299
...
// https://golang.org/s/x86manual#page=1300
func STOSB() {
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1304
...
// al: AL/AX/EAX/RAX
// imm: imm8/16/32
// https://golang.org/s/x86manual#page=1306
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1308
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1311
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1314
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1316
...
// https://golang.org/s/x86manual#page=1318
func SWAPGS() {
...
// https://golang.org/s/x86manual#page=1320
func SYSCALL() {
...
// SYSENTER
// Fast call to privilege level 0 system procedures.
// https://golang.org/s/x86manual#page=1322
func SYSENTER() {
...
// https://golang.org/s/x86manual#page=1325
func SYSEXIT() {
...
// https://golang.org/s/x86manual#page=1328
func SYSRET() {
...
// al: AL/AX/EAX/RAX
// imm: imm8/16/32
// https://golang.org/s/x86manual#page=1331
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1333
...
// reg: ModRM:reg (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1335
...
// reg: ModRM:reg (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1337
...
// https://golang.org/s/x86manual#page=1339
func UD2() {
	unsafe.Asm("UD2", nil)
}
...
// https://golang.org/s/x86manual#page=1340
func UNPCKHPD() {
...
// https://golang.org/s/x86manual#page=1344
func UNPCKHPS() {
...
// https://golang.org/s/x86manual#page=1348
func UNPCKLPD() {
...
// https://golang.org/s/x86manual#page=1352
func UNPCKLPS() {
...
// evex: EVEX.vvvv
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1365
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1687
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=1377
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=1379
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1381
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1387
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1390
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1400
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1397
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1403
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1406
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1408
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1410
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1411
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1413
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1418
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1422
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1420
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1424
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1426
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1427
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1429
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1431
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1433
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1435
...
// evex: EVEX.vvvv
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1437
...
// vex: VEX.vvvv
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1439
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1449
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1451
...
// reg: ModRM:reg (r, w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1453
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1445
...
// reg: ModRM:reg (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1455
...
// reg: ModRM:reg (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1462
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1468
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1472
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1476
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1479
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1482
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1489
...
// vex: VEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1496
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1541
...
// vex: VEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1555
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1521
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1561
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1568
...
// vex: VEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1577
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1580
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1586
...
// vex: VEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1592
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1601
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1603
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1605
...
// vsib: vsib (r)
// vex: VEX.vvvv (r, w)
// https://golang.org/s/x86manual#page=1607
...
// https://golang.org/s/x86manual#page=1617
...
// vsib: vsib (r)
// vex: VEX.vvvv (r, w)
// https://golang.org/s/x86manual#page=1612
...
// vsib: vsib (r)
// https://golang.org/s/x86manual#page=1620
...
// vsib: vsib (r)
// https://golang.org/s/x86manual#page=1623
...
// reg: ModRM:reg (w)
// v: VectorReg(R): VSIB:index
// https://golang.org/s/x86manual#page=1626
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1647
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1653
...
// https://golang.org/s/x86manual#page=1655
func VGETMANTPD() {
...
// https://golang.org/s/x86manual#page=1659
func VGETMANTPS() {
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1662
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1666
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1670
...
// vex: VEX.vvvv (r)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=1674
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1677
...
// evex: EVEX.vvvv
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1679
...
// evex: EVEX.vvvv
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1681
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1375
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1701
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1704
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=1707
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1714
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1716
...
// evex: EVEX.vvvv
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1718
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1740
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1746
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1748
...
// vsib: vsib (r)
// vex: VEX.vvvv (r, w)
// https://golang.org/s/x86manual#page=1629
...
// reg: ModRM:reg (w)
// v: VectorReg(R): VSIB:index
// https://golang.org/s/x86manual#page=1633
...
// vsib: vsib (r)
// vex: VEX.vvvv (r, w)
// https://golang.org/s/x86manual#page=1636
...
// reg: ModRM:reg (w)
// v: VectorReg(R): VSIB:index
// https://golang.org/s/x86manual#page=1641
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1759
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=1774
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=1778
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1756
...
// rm: ModRM:r/m (w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=1762
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1801
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1806
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1826
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1831
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1835
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1838
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1841
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1845
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1847
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1849
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1853
...
// evex: EVEX.vvvv
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1851
...
// evex: EVEX.vvvv
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1855
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1862
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1860
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1866
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1872
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1870
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1875
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1877
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1881
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1879
...
// vex: VEX.vvvv
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1883
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1885
...
// reg: ModRM:reg (w)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1889
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1887
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1891
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1896
...
// vsib: vsib (r)
// https://golang.org/s/x86manual#page=1907
...
// vsib: vsib (r)
// https://golang.org/s/x86manual#page=1909
...
// rm: ModRM:r/m (r)
// imm: imm8
// https://golang.org/s/x86manual#page=1911
...
// reg: ModRM:reg (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1916
...
// evex: EVEX.vvvv (r)
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1952
...
// evex: EVEX.vvvv
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1955
...
// https://golang.org/s/x86manual#page=1919
func VZEROALL() {
...
// https://golang.org/s/x86manual#page=1921
func VZEROUPPER() {
...
// https://golang.org/s/x86manual#page=1924
func WBINVD() {
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1926
...
// https://golang.org/s/x86manual#page=1928
func WRMSR() {
...
// https://golang.org/s/x86manual#page=1930
func WRPKRU() {
...
// imm: imm8
// https://golang.org/s/x86manual#page=1935
...
// https://golang.org/s/x86manual#page=1931
func XACQUIRE() {
...
// rm: ModRM:r/m (r, w)
// reg: ModRM:reg (r, w)
// https://golang.org/s/x86manual#page=1937
...
// offset: Offset
// https://golang.org/s/x86manual#page=1939
...
// rm: ModRM:r/m (r, w)
// reg: ModRM:reg (r)
// https://golang.org/s/x86manual#page=1942
...
// https://golang.org/s/x86manual#page=1944
func XEND() {
	unsafe.Asm("XEND", nil)
}
...
// https://golang.org/s/x86manual#page=1946
func XGETBV() {
...
// https://golang.org/s/x86manual#page=1948
func XLATB() {
...
// al: AL/AX/EAX/RAX
// imm: imm8/16/32
// https://golang.org/s/x86manual#page=1950
...
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1958
...
// Restore state components specified by EDX:EAX from mem.
// rm: ModRM:r/m (r)
// https://golang.org/s/x86manual#page=1962
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1966
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1969
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1972
...
// rm: ModRM:r/m (w)
// https://golang.org/s/x86manual#page=1975
...
// https://golang.org/s/x86manual#page=1978
func XSETBV() {
...
// https://golang.org/s/x86manual#page=1980
func XTEST() {
